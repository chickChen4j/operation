package com.efivestar.operation.aop;

import com.efivestar.operation.dto.ResultDTO;
import com.efivestar.operation.http.ResourceServlet;
...
public class HandlerAspect {
  ...
  @Pointcut("execution(public void com.efivestar.operation.service.*.*(..))")
  public void handlerPointcut() {
    //RestfulService中的增删改方法
    // Method is empty as this is just a Pointcut, the implementations are in the advices.
  }

  @Pointcut("execution(public boolean com.efivestar.operation.service.ConfigService.*(..))")
  public void configPointcut() {

  }

  @Pointcut("execution(public * com.efivestar.operation.controller.*.*(..))")
  public void allController() {

  }

//  @Pointcut("execution(public * com.efivestar.operation.controller.RestfulController.)")
